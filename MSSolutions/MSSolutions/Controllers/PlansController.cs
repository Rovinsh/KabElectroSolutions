    ...
    public class PlansController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPlans()
        {
         ...
         .Select(p => new PlansDTO
         {
             ...
             CatId = p.CatId,
             BrandId = p.BrandId,
             CategoryName = _context.MsCategories.Where(c => c.Id == p.CatId).Select(c => c.CatName).FirstOrDefault(),
             BrandName = _context.MsBrands.Where(b => b.Id == p.BrandId).Select(c => c.BrandName).FirstOrDefault(),
             PlanName = p.PlanName,
