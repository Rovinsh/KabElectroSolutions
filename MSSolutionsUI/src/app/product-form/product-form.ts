...
export class ProductFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.productForm= this.fb.group({
      ...
      cashlessService: [''],
      authorizedServiceCentreRepairs: [''],
      claimType: [''],
      serviceCancellationRefundPeriod: [''],
      extendedHoursSupport: [''],
      supportCentreContactDetails: [''],
      howtoClaim: [''],
      serviceType: [''],
      installationDemo: [''],
 ...
 private patchEditData() {
  ...
  this.productForm.patchValue({
    ...
    cashlessService: record.cashlessService,
    authorizedServiceCentreRepairs: record.authorizedServiceCentreRepairs,
    claimType: record.claimType,
    serviceCancellationRefundPeriod: record.serviceCancellationRefundPeriod,
    extendedHoursSupport: record.extendedHoursSupport,
    supportCentreContactDetails: record.supportCentreContactDetails,
    howtoClaim: record.howtoClaim,
    serviceType: record.serviceType,
    installationDemo: record.installationDemo,
    customerSupportEmail: record.customerSupportEmail,
    repairCostCovered: record.repairCostCovered,
    serviceExcludes: record.serviceExcludes,
    serviceIncludes: record.serviceIncludes,
    marketerNameAddress: record.marketerNameAddress,
    documentsRequired: record.documentsRequired,
    costCovered: record.costCovered,
